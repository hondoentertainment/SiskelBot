...
/** @param {string} runId @returns {{ totalUsd: number, prompt: number, completion: number, total: number } | null} */
export function getRunCostAccumulator(runId) {
...
export function __getAccumulatorForTests(runId) {
  return getRunCostAccumulator(runId);
}
