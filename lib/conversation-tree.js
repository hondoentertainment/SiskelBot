...
/**
 * Helper: load the dedicated branches list for a workspace/user.
 */
async function loadBranches(workspace = "default", userId = "anonymous") {
  // We store branch metadata inside the conversations storage as items with _isBranch flag
