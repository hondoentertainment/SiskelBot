...
export function getDiarizationCapabilities() {
  return {
    provider: process.env.DIARIZATION_PROVIDER || DEFAULT_PROVIDER,
    providers: {
      openai: Boolean(process.env.OPENAI_API_KEY || process.env.WHISPER_API_KEY),
      assemblyai: Boolean(process.env.ASSEMBLYAI_API_KEY),
      deepgram: Boolean(process.env.DEEPGRAM_API_KEY),
      pyannote: Boolean(process.env.HUGGINGFACE_API_KEY),
    },
  };
}
