 ...
 * Returns the plan name string ("free" | "pro" | "enterprise").
 * Fails open to "free" if storage is unavailable or has no billing record.
 */
 ...
 * Priority: admin override fields > plan defaults > env fallback.
...
async function getQuotasForWorkspace(workspaceId, storage) {
  ...
  if (!storage || typeof storage.get !== "function") {
    return { ...envDefaults, ...base, plan, source: "plan" };
  }
  ...
  try {
    ...
    if (item && typeof item === "object") {
      ...
      return {
        ...
        ...override,
        plan,
        source: hasOverride ? "override" : "plan",
      };
    }
  } catch {
    // Storage failure -> use plan limits (fail open)
  }
  return { ...base, plan, source: "plan" };
}
