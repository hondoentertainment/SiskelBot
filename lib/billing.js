 ...
 * @param {{ workspaceId: string, userId: string, planId: string, successUrl: string, cancelUrl: string }} params
 * @returns {Promise<{ url: string, sessionId: string } | { url: null, sessionId: null }>}
 */
export async function createCheckoutSession({ workspaceId, userId, planId, successUrl, cancelUrl }) {
