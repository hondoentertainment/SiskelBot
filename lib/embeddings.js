...
import { recordEmbeddingCacheHit, recordEmbeddingCacheMiss } from "./metrics.js";
...
export async function embed(text) {
  ...
  // Phase 35.2: Cache lookup on normalized text.
  try {
...
export async function embedBatch(texts) {
  ...
  for (let i = 0; i < missing.length; i++) recordEmbeddingCacheMiss();
