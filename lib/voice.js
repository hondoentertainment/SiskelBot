...
const DEFAULT_TTS_MODEL = process.env.TTS_MODEL || "tts-1";
const DEFAULT_TTS_VOICE = process.env.TTS_VOICE || "alloy";
...
export function isVoiceConfigured() {
  const sttKey = WHISPER_API_KEY || OPENAI_API_KEY;
  const ttsKey = OPENAI_API_KEY;
  return {
    stt: Boolean(sttKey),
    tts: Boolean(ttsKey),
