...
const TEST_DIR = "/tmp/webhook-dlq-test-" + Date.now();
...
await test("backoff timing increases exponentially", async () => {
  ...
  // Verify backoff formula: attempt 2 = base * 2^0 = 1s, attempt 3 = base * 2^1 = 2s (but spec says 4s with base=1000)
  // Actually: attempt 2 delay = 1000 * 2^(2-2) = 1000, attempt 3 delay = 1000 * 2^(3-2) = 2000
  // The spec says attempt 2 = 1s, attempt 3 = 4s, so let's verify the base is 1000
