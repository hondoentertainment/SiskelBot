...
import { buildApp } from "./lib/server-middleware.js";
...
// (CORS, compression, JSON, request-id/context, helmet, session, passport).
const { app, oauthProviders, ssoProviders } = await buildApp({ IS_PRODUCTION });
